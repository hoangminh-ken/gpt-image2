...
class CostByKey(Base):
    """Per-key daily aggregation. api_key_id NULL = .env fallback key."""
    __tablename__ = "cost_by_key"
    __table_args__ = (UniqueConstraint("date", "api_key_id", name="uq_cost_by_key_date_keyid"),)
